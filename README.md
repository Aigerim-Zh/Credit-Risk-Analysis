...
### Data and Resources
The dataset used is credit card data from LendingClub, a peer-to-peer lending services company.
Python 3.7 
Scikit-learn
...
### Deliverable 3
The last two models are focused on ensemble learning. The code is available [here](https://github.com/Aigerim-Zh/Credit-Risk-Analysis/blob/main/credit_risk_ensemble.ipynb).
...
A random forest model combines many decision trees into a forest of trees.
